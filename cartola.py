...
nome_arquivo = f"relatorio_cartola_{data_hora_atual}.html"

# Modificar os valores do campo 'foto' para incluir os links
df_combined['foto'] = '<a href="' + df_combined['foto'] + '">link</a>'

# Gerar o relatório HTML com os links das fotos e campos vazios substituídos por 0
html = f"""
<html>
<head>
...
<body>
    {df_combined.to_html(escape=False, classes='table table-bordered table-striped')}
</body>
</html>
"""
