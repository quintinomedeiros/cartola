...
if tabelas_completas:
    ...
    for nome_tabela, tabela in tabelas.items():
        ...
        if nome_tabela == 'Atletas mercado':
            ...
            print('Campos disponíveis: atleta_id, apelido, rodada_id, clube_id, posicao_id, status_id, etc.')
            '''
        ...
        if nome_tabela == 'Dados Destaque':
            ...
            posicao_abreviacao: abreviação do nome da posição do atleta
        ...
        if nome_tabela == 'Dados Times':
            print('Esta tabela contém informações sobre os times participantes do CartolaFC de 2023.')
            print('Campos disponíveis: clube_id, clube_nome e abreviacao')
            '''
        ...
        if nome_tabela == 'Posicoes':
            print('Esta tabela contém informações o id e o nome das posições dos jogadores.')
            print('Campos disponíveis: id e nome')
            '''
            id: identificador da posição do jogador
            nome: nome da posição do jogador
            '''    
        
        if nome_tabela == 'Status':
            print('Esta tabela contém informações sobre a o id e o nome do status dos jogadores.')
            print('Campos disponíveis: id, nome')
            '''
            id: identificador do status do jogador
            nome: nome do status do jogador
            '''    
